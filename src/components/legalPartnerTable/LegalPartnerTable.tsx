...
import styles from './LegalPartnerTable.module.scss';
...
function LegalPartnerTable() {
	...
	interface Column {
		id: 'provider_name' | 'integration_status' | 'created_by' | 'created_date';
		label: any;
		minWidth?: number;
...
export default LegalPartnerTable;
