...
import styles from './LegalRegularTable.module.scss';
...
function LegalRegularTable() {
	...
	interface Column {
		id: 'regulator' | 'integration_status' | 'created_by' | 'created_date';
		label: any;
		minWidth?: number;
		align?: 'right' | 'left' | 'center';
	}
	const columns: Column[] = [
		{ id: 'regulator', label: 'Regulator name', minWidth: 100 },
		{
		...
		<div style={{ paddingTop: '10px' }}>
			...
			<div className={styles.header}>
				<div className={styles.header_left}>
					<h1 className={styles.header_left_h1}>{apiRes?.length} regulators</h1>
				</div>
...
export default LegalRegularTable;
